...
<link rel="stylesheet" href="<?php bloginfo('stylesheet_url'); ?>" type="text/css" media="screen, print" title="Yashfa Themes" />
...
<?php wp_head(); ?>
<link rel="stylesheet" href="<?php bloginfo('template_directory'); ?>/css-navi.css" type="text/css" media="screen" />
...
<div  id="navr2">
  <ul class="menu clearfix">
    ...
    <li><a href="http://www.cbpp.org">CBPP.org</a></li>
...
<div id="header" onclick="location.href='<?php echo get_settings('home'); ?>';" style="cursor: pointer;">
		<h1><a href="<?php echo get_option('home'); ?>/"><?php bloginfo('name'); ?></a></h1><img name="masthead" src="http://www.offthechartsblog.org/wp-content/themes/yashfa/images/header.jpg" width="950" height="170" border="0" alt="Off the Charts: Policy Insight Beyond the Numbers"/><div class="description"><?php bloginfo('description'); ?></div>
</div>
