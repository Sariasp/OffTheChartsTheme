...
<p class="cinfo"><?php _e('Comments are listed in reverse chronological order.','yashfa');?></p>
...
<div id="commentpolicy" style="font-size:8pt;">
<p>Comment Policy:<br><br>
Thank you for joining the conversation about important policy issues.  Comments are limited to 1,500 characters and are subject to approval and moderation. We reserve the right to remove comments that:<br><br>
<ul style="margin-left:20px;">
<li style="margin-left:20px;">are injurious, defamatory, profane, off-topic or inappropriate;</li> 
<li style="margin-left:20px;">contain personal attacks or racist, sexist, homophobic, or other slurs;</li>
<li style="margin-left:20px;">solicit and/or advertise for personal blogs and websites or to sell products or services;</li> 
<li style="margin-left:20px;">may infringe the copyright or intellectual property rights of others or other applicable laws or regulations; or</li>
<li style="margin-left:20px;">are otherwise inconsistent with the goals of this blog.</li>
</ul><br>
Posted comments do not necessarily represent the views of the CBPP and do not constitute official endorsement by CBPP. Please note that comments will be approved during the Center's business hours. If you have questions, please contact communications@cbpp.org.</p><br><br></div>
